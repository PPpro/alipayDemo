...
const shaderSource = require('./shader');
...
function main() {
  ...
  // setup GLSL programs
  const textureProgramInfo = webglUtils.createProgramInfo(gl, [shaderSource.vs, shaderSource.fs]);
  const colorProgramInfo = webglUtils.createProgramInfo(gl, [shaderSource.col_vs, shaderSource.col_fs]);
